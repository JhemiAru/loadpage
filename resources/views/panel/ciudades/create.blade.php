...
<div class="panel-card">
    <div class="panel-card-header">
        <h5><i class="fas fa-plus-circle me-2"></i> Nueva ciudad</h5>
    </div>

    <form method="POST" action="{{ route('guardarCiudad') }}" style="padding: 28px;">
        @csrf
        ...
        <div class="row g-4">
            ...
            <div class="col-12 form-group">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control-panel @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" required maxlength="255" placeholder="Ej: La Paz, Santa Cruz, Cochabamba">
                @error('nombre')
            ...
            <div class="col-12 form-group">
                ...
                <input type="text" id="slug" name="slug" class="form-control-panel @error('slug') is-invalid @enderror" value="{{ old('slug') }}" required placeholder="Ej. el-alto, tarija">
        ...
        <div class="d-flex gap-3 mt-4 pt-3 border-top">
            <button type="submit" class="btn-primary-panel"><i class="fas fa-save"></i> Guardar ciudad</button>
